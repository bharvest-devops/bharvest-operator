...
func (in *CosmosPruningStatus) DeepCopyInto(out *CosmosPruningStatus) {
	*out = *in
	if in.Candidates != nil {
		...
		*out = make(map[string]SelfHealingCandidate, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SelfHealingCandidate) DeepCopyInto(out *SelfHealingCandidate) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SelfHealingCandidate.
func (in *SelfHealingCandidate) DeepCopy() *SelfHealingCandidate {
	if in == nil {
		return nil
	}
	out := new(SelfHealingCandidate)
	in.DeepCopyInto(out)
	return out
}
