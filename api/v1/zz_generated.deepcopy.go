...
func (in *HeightDriftMitigationSpec) DeepCopyInto(out *HeightDriftMitigationSpec) {
	*out = *in
	out.ThresholdTime = in.ThresholdTime
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodStartingFailureStatus) DeepCopyInto(out *PodStartingFailureStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodStartingFailureStatus.
func (in *PodStartingFailureStatus) DeepCopy() *PodStartingFailureStatus {
	if in == nil {
		return nil
	}
	out := new(PodStartingFailureStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SelfHealingStatus) DeepCopyInto(out *SelfHealingStatus) {
	*out = *in
	...
	if in.PodStartingFailure != nil {
		in, out := &in.PodStartingFailure, &out.PodStartingFailure
		*out = make(map[string]*PodStartingFailureStatus, len(*in))
		for key, val := range *in {
			var outVal *PodStartingFailureStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
